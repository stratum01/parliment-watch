      ...
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <div className="p-6">
          <div className="bg-yellow-50 border border-yellow-200 text-yellow-700 p-4 rounded-md mb-6">
            ...
            <p className="mb-2">
              Due to Cross-Origin Resource Sharing (CORS) restrictions, we're unable to directly fetch detailed information about this vote from the OpenParliament API.
            </p>
            <p>
              You can view the full details of this vote on the official OpenParliament website:
            </p>
          </div>
          
          <div className="mt-4">
            <a 
              href={`https://openparliament.ca/votes/44-1/${voteId}/`}
              target="_blank"
            ...
            >
              ...
              View Vote #{voteId} on OpenParliament.ca
            </a>
          </div>
